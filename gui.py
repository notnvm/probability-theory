...
class Gui:
    def __init__(self, master):
        ...
        self.label_p = tk.Label(master, text='Введите кол-во экcп.:', foreground="white", background='#252526',
                                font='Arial 12')
        self.label_p.place(x=0, y=0)
        self.label_n = tk.Label(master, text='Введите значение N:', foreground="white", background='#252526',
                                font='Arial 12')
        self.label_n.place(x=0, y=40)
        self.label_m = tk.Label(master, text='Введите значение M:', foreground="white", background='#252526',
                                font='Arial 12')
        self.label_m.place(x=0, y=80)
        self.label_r = tk.Label(master, text='Введите значение r:', foreground="white", background='#252526',
                                font='Arial 12')
        ...
        self.solve_btn = tk.Button(master, text='Решить', font='Arial 12', width=33, foreground='white',
                                   background='#252526', command=self.solve_callback)
    ...
    def solve_callback(self):
        ...
        sdf_intervals = solution.get_sdf_intervals()
        tdf_intervals = solution.get_tdf_intervals()
        ...
        for i in range(0, r):
            plt.hlines(tdf[i + 1], i, i + 1, color='blue')
        plt.hlines(0, -2, 0, color='blue')
        plt.hlines(1, r, r + 1, color='blue')
